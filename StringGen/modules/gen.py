...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Mrshubh_1227"))
        else:
            ...
            await client.join_chat("Mrshubh_1227")
    except KeyError:
        pass
    try:
